...
async function DeleteMilkById(req,res){
    ...
    try {
        ...
        return res.status(200).json(new ApiResponse(200,response,'Milk volume deleted'))
    } catch (error) {
        return res.status(500).json(new ApiResponse(500,null,'Internal Server Error'))
    }
}
...
export { RegisterMilkVolume, GetMilkVolume, GetMilkVolumeByGestationalAge,GetMilkVolumeByDonor,GetMilkById,DeleteMilkById };
