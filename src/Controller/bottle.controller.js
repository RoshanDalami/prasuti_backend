...
async function GenerateBottle(req,res){
    try {
        const { poolingId, poolingCondition, expireDate, totalVolume,poolingDate } = req.body;
        ...
        return res.status(200).json(new ApiResponse(200,savedBottle,'Bottle generated successfully'))
...
async function GetBottle(req,res){
    try {
        ...
        return res.status(200).json(new ApiResponse(200,response,'Bottle list generated successfully'))
